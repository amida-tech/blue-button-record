...
var bbToMongoose = function(description) {
    ...
    if (Array.isArray(description)) {
        ...
        if (!elem) {
            logger.error('unknown description in array: ' + description);
        ...
        var result = Object.keys(description).reduce(function(r, key) {
            ...
            if (!elem) {
                logger.error('unknown description in object: ' + description);
        ...
        if (f) {
            ...
            logger.error('unknown description: ' + description);
...
exports.models = function(connection, schemas, matchFields) {
    var result = {
        merge: {},
        clinical: {},
        match: {}
    };
    Object.keys(schemas).forEach(function(secName) {
        ...
        var matchFieldDesc = bbToMongoose(matchFields);
        _.extend(matchSchemaDesc, matchFieldDesc);
