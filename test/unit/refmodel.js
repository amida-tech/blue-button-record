...
exports.prepareConnection = function (options, context) {
  ...
  return function () {
    ...
    it('check connection and models', function (done) {
      expect(context.dbinfo).toBeDefined();
      expect(context.dbinfo.db).toBeDefined();
      expect(context.dbinfo.GridStore).toBeDefined();
      expect(context.dbinfo.ObjectID).toBeDefined();
      expect(context.dbinfo.models).toBeDefined();
      expect(context.dbinfo.models.testallergies).toBeDefined();
      expect(context.dbinfo.models.testprocedures).toBeDefined();
      expect(context.dbinfo.models.testdemographics).toBeDefined();
      done();
    });
  };
};
